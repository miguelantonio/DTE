 ...
 */
public class SignatureTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements cl.sii.siiDte.libroboletas.SignatureType
{
     ...
     */
    public cl.sii.siiDte.libroboletas.SignatureType.SignedInfo getSignedInfo()
    {
        synchronized (monitor())
        {
            check_orphaned();
            cl.sii.siiDte.libroboletas.SignatureType.SignedInfo target = null;
            target = (cl.sii.siiDte.libroboletas.SignatureType.SignedInfo)get_store().find_element_user(SIGNEDINFO$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setSignedInfo(cl.sii.siiDte.libroboletas.SignatureType.SignedInfo signedInfo)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (cl.sii.siiDte.libroboletas.SignatureType.SignedInfo)get_store().add_element_user(SIGNEDINFO$0);
            }
     ...
     */
    public cl.sii.siiDte.libroboletas.SignatureType.SignedInfo addNewSignedInfo()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public cl.sii.siiDte.libroboletas.SignatureType.KeyInfo getKeyInfo()
    {
        synchronized (monitor())
        {
            check_orphaned();
            cl.sii.siiDte.libroboletas.SignatureType.KeyInfo target = null;
            target = (cl.sii.siiDte.libroboletas.SignatureType.KeyInfo)get_store().find_element_user(KEYINFO$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setKeyInfo(cl.sii.siiDte.libroboletas.SignatureType.KeyInfo keyInfo)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (cl.sii.siiDte.libroboletas.SignatureType.KeyInfo)get_store().add_element_user(KEYINFO$4);
            }
            target.set(keyInfo);
        }
    }
     ...
     */
    public cl.sii.siiDte.libroboletas.SignatureType.KeyInfo addNewKeyInfo()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class SignedInfoImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements cl.sii.siiDte.libroboletas.SignatureType.SignedInfo
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.CanonicalizationMethod getCanonicalizationMethod()
        {
            synchronized (monitor())
            {
                check_orphaned();
                cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.CanonicalizationMethod target = null;
                target = (cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.CanonicalizationMethod)get_store().find_element_user(CANONICALIZATIONMETHOD$0, 0);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public void setCanonicalizationMethod(cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.CanonicalizationMethod canonicalizationMethod)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.CanonicalizationMethod)get_store().add_element_user(CANONICALIZATIONMETHOD$0);
                }
         ...
         */
        public cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.CanonicalizationMethod addNewCanonicalizationMethod()
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.SignatureMethod getSignatureMethod()
        {
            synchronized (monitor())
            {
                check_orphaned();
                cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.SignatureMethod target = null;
                target = (cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.SignatureMethod)get_store().find_element_user(SIGNATUREMETHOD$2, 0);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public void setSignatureMethod(cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.SignatureMethod signatureMethod)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.SignatureMethod)get_store().add_element_user(SIGNATUREMETHOD$2);
                }
         ...
         */
        public cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.SignatureMethod addNewSignatureMethod()
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference getReference()
        {
            synchronized (monitor())
            {
                check_orphaned();
                cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference target = null;
                target = (cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference)get_store().find_element_user(REFERENCE$4, 0);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public void setReference(cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference reference)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference)get_store().add_element_user(REFERENCE$4);
                }
         ...
         */
        public cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference addNewReference()
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         * This is a complex type.
         */
        public static class CanonicalizationMethodImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.CanonicalizationMethod
        {
            private static final long serialVersionUID = 1L;
         ...
         * This is a complex type.
         */
        public static class SignatureMethodImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.SignatureMethod
        {
            private static final long serialVersionUID = 1L;
             ...
             * Gets (as xml) the "Algorithm" attribute
             */
            public cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.SignatureMethod.Algorithm xgetAlgorithm()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.SignatureMethod.Algorithm target = null;
                    target = (cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.SignatureMethod.Algorithm)get_store().find_attribute_user(ALGORITHM$0);
                    return target;
                }
            }
             ...
             * Sets (as xml) the "Algorithm" attribute
             */
            public void xsetAlgorithm(cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.SignatureMethod.Algorithm algorithm)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    ...
                    if (target == null)
                    {
                      target = (cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.SignatureMethod.Algorithm)get_store().add_attribute_user(ALGORITHM$0);
                    }
                    target.set(algorithm);
                }
            }
             ...
             */
            public static class AlgorithmImpl extends org.apache.xmlbeans.impl.values.JavaUriHolderEx implements cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.SignatureMethod.Algorithm
            {
                private static final long serialVersionUID = 1L;
         ...
         * This is a complex type.
         */
        public static class ReferenceImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference
        {
            private static final long serialVersionUID = 1L;
             ...
             */
            public cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference.Transforms getTransforms()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference.Transforms target = null;
                    target = (cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference.Transforms)get_store().find_element_user(TRANSFORMS$0, 0);
                    if (target == null)
                    {
                      return null;
                    }
             ...
             */
            public void setTransforms(cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference.Transforms transforms)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    ...
                    if (target == null)
                    {
                      target = (cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference.Transforms)get_store().add_element_user(TRANSFORMS$0);
                    }
             ...
             */
            public cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference.Transforms addNewTransforms()
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference.DigestMethod getDigestMethod()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference.DigestMethod target = null;
                    target = (cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference.DigestMethod)get_store().find_element_user(DIGESTMETHOD$2, 0);
                    if (target == null)
                    {
                      return null;
                    }
             ...
             */
            public void setDigestMethod(cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference.DigestMethod digestMethod)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    ...
                    if (target == null)
                    {
                      target = (cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference.DigestMethod)get_store().add_element_user(DIGESTMETHOD$2);
                    }
             ...
             */
            public cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference.DigestMethod addNewDigestMethod()
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             * This is a complex type.
             */
            public static class TransformsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference.Transforms
            {
                private static final long serialVersionUID = 1L;
                 ...
                 */
                public cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference.Transforms.Transform getTransform()
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference.Transforms.Transform target = null;
                      target = (cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference.Transforms.Transform)get_store().find_element_user(TRANSFORM$0, 0);
                      if (target == null)
                      {
                        return null;
                      }
                 ...
                 */
                public void setTransform(cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference.Transforms.Transform transform)
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      ...
                      if (target == null)
                      {
                        target = (cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference.Transforms.Transform)get_store().add_element_user(TRANSFORM$0);
                      }
                 ...
                 */
                public cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference.Transforms.Transform addNewTransform()
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                 ...
                 * This is a complex type.
                 */
                public static class TransformImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference.Transforms.Transform
                {
                    private static final long serialVersionUID = 1L;
             ...
             * This is a complex type.
             */
            public static class DigestMethodImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements cl.sii.siiDte.libroboletas.SignatureType.SignedInfo.Reference.DigestMethod
            {
                private static final long serialVersionUID = 1L;
     ...
     * This is a complex type.
     */
    public static class KeyInfoImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements cl.sii.siiDte.libroboletas.SignatureType.KeyInfo
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.KeyValue getKeyValue()
        {
            synchronized (monitor())
            {
                check_orphaned();
                cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.KeyValue target = null;
                target = (cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.KeyValue)get_store().find_element_user(KEYVALUE$0, 0);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public void setKeyValue(cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.KeyValue keyValue)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.KeyValue)get_store().add_element_user(KEYVALUE$0);
                }
                target.set(keyValue);
            }
        }
         ...
         */
        public cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.KeyValue addNewKeyValue()
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.X509Data getX509Data()
        {
            synchronized (monitor())
            {
                check_orphaned();
                cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.X509Data target = null;
                target = (cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.X509Data)get_store().find_element_user(X509DATA$2, 0);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public void setX509Data(cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.X509Data x509Data)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.X509Data)get_store().add_element_user(X509DATA$2);
                }
                target.set(x509Data);
            }
        }
         ...
         */
        public cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.X509Data addNewX509Data()
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         * This is a complex type.
         */
        public static class KeyValueImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.KeyValue
        {
            private static final long serialVersionUID = 1L;
             ...
             */
            public cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.KeyValue.RSAKeyValue getRSAKeyValue()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.KeyValue.RSAKeyValue target = null;
                    target = (cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.KeyValue.RSAKeyValue)get_store().find_element_user(RSAKEYVALUE$0, 0);
                    if (target == null)
                    {
                      return null;
                    }
             ...
             */
            public void setRSAKeyValue(cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.KeyValue.RSAKeyValue rsaKeyValue)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    ...
                    if (target == null)
                    {
                      target = (cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.KeyValue.RSAKeyValue)get_store().add_element_user(RSAKEYVALUE$0);
                    }
             ...
             */
            public cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.KeyValue.RSAKeyValue addNewRSAKeyValue()
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.KeyValue.DSAKeyValue getDSAKeyValue()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.KeyValue.DSAKeyValue target = null;
                    target = (cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.KeyValue.DSAKeyValue)get_store().find_element_user(DSAKEYVALUE$2, 0);
                    if (target == null)
                    {
                      return null;
                    }
             ...
             */
            public void setDSAKeyValue(cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.KeyValue.DSAKeyValue dsaKeyValue)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    ...
                    if (target == null)
                    {
                      target = (cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.KeyValue.DSAKeyValue)get_store().add_element_user(DSAKEYVALUE$2);
                    }
             ...
             */
            public cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.KeyValue.DSAKeyValue addNewDSAKeyValue()
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             * This is a complex type.
             */
            public static class RSAKeyValueImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.KeyValue.RSAKeyValue
            {
                private static final long serialVersionUID = 1L;
             ...
             * This is a complex type.
             */
            public static class DSAKeyValueImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.KeyValue.DSAKeyValue
            {
                private static final long serialVersionUID = 1L;
         ...
         * This is a complex type.
         */
        public static class X509DataImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements cl.sii.siiDte.libroboletas.SignatureType.KeyInfo.X509Data
        {
            private static final long serialVersionUID = 1L;
